...
ASTNode::ASTNode(const cypher_astnode_t *node, Napi::Object parentJSObject)
{
  m_node = node;
  m_parent = parentJSObject;
}

void ASTNode::Walk(Napi::Env env)
{
...
void ASTNode::AddMember(Napi::Env env, const char *key, const char *value)
{
  auto jsKey = Napi::String::New(env, key);
  auto jsValue = Napi::String::New(env, value);
  m_parent.Set(jsKey, jsValue);
}

void ASTNode::AddMember(Napi::Env env, const char *key, int value)
{
  auto jsKey = Napi::String::New(env, key);
  auto jsValue = Napi::Number::New(env, value);
  m_parent.Set(jsKey, jsValue);
}

void ASTNode::AddMember(Napi::Env env, const char *key, bool value)
{
  auto jsKey = Napi::String::New(env, key);
  auto jsValue = Napi::Boolean::New(env, value);
  m_parent.Set(jsKey, jsValue);
}

void ASTNode::AddMemberInt(Napi::Env env, const char *key, specific_node_getter getter) 
{
  AddMemberInt(env, key, getter(m_node));
}

void ASTNode::AddMemberInt(Napi::Env env, const char *key, const cypher_astnode_t *intNode) 
{
  if (!intNode)
  {
...
void ASTNode::AddMemberFloat(Napi::Env env, const char *key, specific_node_getter getter) 
{
  AddMemberFloat(env, key, getter(m_node));
}

void ASTNode::AddMemberFloat(Napi::Env env, const char *key, const cypher_astnode_t *floatNode) 
{
  if (!floatNode)
  {
    AddMemberNull(env, key);
  ...
  try
  {
    ...
    auto jsKey = Napi::String::New(env, key);
    auto jsValue = Napi::Number::New(env, ld);
...
void ASTNode::AddMemberStr(Napi::Env env, const char *key, specific_node_getter getter) 
{
...
void ASTNode::AddMemberNull(Napi::Env env, const char *key) 
{
  auto jsKey = Napi::String::New(env, key);
...
void ASTNode::AddMemberOp(Napi::Env env, const char *key, operator_getter getter) 
{
  AddMember(env, key, ParseOp(getter(m_node)));
}

void ASTNode::Node(Napi::Env env, const char *name, const cypher_astnode_t *node)
{
  if (!node)
  {
    return;
  ...
  auto jsKey = Napi::String::New(env, name);
  const Napi::Object jsValue = Napi::Object::New(env);
  m_parent.Set(jsKey, jsValue);
...
void ASTNode::Node(Napi::Env env, const char *name, specific_node_getter getter)
{
  Node(env, name, getter(m_node));
}

void ASTNode::LoopNodes(Napi::Env env, const char *name, unsigned int counter, node_getter getter)
{
...
void ASTNode::LoopNodes(Napi::Env env, const char *name, node_counter counter, node_getter getter)
{
  LoopNodes(env, name, counter(m_node), getter);
}

void ASTNode::LoopOps(Napi::Env env, const char *name, node_counter counter, op_getter getter)
{
  auto nodes = Napi::Array::New(env);
  auto jsKey = Napi::String::New(env, name); 
  ...
  )
{
  ...
  for (unsigned int i = 0; i < counter(m_node); i++)
  {
    ...
    auto jsKey = Napi::Object::New(env);
    ASTNode keyAst(keyNode, jsKey);
    keyAst.Walk(env);

    
    auto jsValue = Napi::Object::New(env);
    ASTNode valueAst(valueNode, jsValue);
    valueAst.Walk(env);

    auto itemObj = Napi::Object::New(env);
    ...
    m_parent.Set(Napi::String::New(env, name), items);
  }


// WALKERS
void ASTNode::WalkParameter(Napi::Env env)
{
  AddMember(env, "type", "parameter");
  AddMember(env, "name", cypher_ast_parameter_get_name(m_node));
}

void ASTNode::WalkMatch(Napi::Env env)
{
...
void ASTNode::WalkQuery(Napi::Env env)
{
...
void ASTNode::WalkStatement(Napi::Env env)
{
...
void ASTNode::WalkStatementOption(Napi::Env env)
{
  AddMember(env, "type", "statement-option");
}

void ASTNode::WalkCypherOption(Napi::Env env)
{
...
void ASTNode::WalkCypherOptionParam(Napi::Env env)
{
...
void ASTNode::WalkExplainOption(Napi::Env env)
{
  WalkStatementOption(env);
}

void ASTNode::WalkProfileOption(Napi::Env env)
{
  WalkStatementOption(env);
}

void ASTNode::WalkCreateNodePropIndex(Napi::Env env)
{
...
void ASTNode::WalkDropNodePropIndex(Napi::Env env)
{
...
void ASTNode::WalkCreateNodePropConstraint(Napi::Env env)
{
...
void ASTNode::WalkDropNodePropConstraint(Napi::Env env)
{
...
void ASTNode::WalkCreateRelPropConstraint(Napi::Env env)
{
...
void ASTNode::WalkDropRelPropConstraint(Napi::Env env)
{
...
void ASTNode::WalkStart(Napi::Env env)
{
...
void ASTNode::WalkNodeIndexLookup(Napi::Env env)
{
...
void ASTNode::WalkNodeIndexQuery(Napi::Env env)
{
...
void ASTNode::WalkNodeIdLookup(Napi::Env env)
{
...
void ASTNode::WalkRelIndexQuery(Napi::Env env)
{
...
void ASTNode::WalkRelIdLookup(Napi::Env env)
{
...
void ASTNode::WalkUsingJoin(Napi::Env env)
{
...
void ASTNode::WalkUsingScan(Napi::Env env)
{
...
void ASTNode::WalkMerge(Napi::Env env)
{
...
void ASTNode::WalkSetAllProperties(Napi::Env env)
{
...
void ASTNode::WalkMergeProperties(Napi::Env env)
{
...
void ASTNode::WalkSetLabels(Napi::Env env)
{
...
void ASTNode::WalkDelete(Napi::Env env)
{
...
void ASTNode::WalkWith(Napi::Env env)
{
...
void ASTNode::WalkUnwind(Napi::Env env)
{
...
void ASTNode::WalkCall(Napi::Env env)
{
...
void ASTNode::WalkReturn(Napi::Env env)
{
...
void ASTNode::WalkProjection(Napi::Env env)
{
...
void ASTNode::WalkUnion(Napi::Env env)
{
  AddMember(env, "type", "union");
  AddMember(env, "all", (bool)cypher_ast_union_has_all(m_node));
}

void ASTNode::WalkUnaryOperator(Napi::Env env)
{
...
void ASTNode::WalkBinaryOperator(Napi::Env env)
{
...
void ASTNode::WalkComparison(Napi::Env env)
{
...
void ASTNode::WalkApplyOperator(Napi::Env env)
{
...
void ASTNode::WalkApplyAllOperator(Napi::Env env)
{
...
void ASTNode::WalkPropertyOperator(Napi::Env env)
{
...
void ASTNode::WalkSubscriptOperator(Napi::Env env)
{
...
void ASTNode::WalkSliceOperator(Napi::Env env)
{
...
void ASTNode::WalkMapProjection(Napi::Env env)
{
...
void ASTNode::WalkMapProjectionLiteral(Napi::Env env)
{
...
void ASTNode::WalkListComprehension(Napi::Env env)
{
...
void ASTNode::WalkPatternComprehension(Napi::Env env)
{
...
void ASTNode::WalkCase(Napi::Env env)
{
...
void ASTNode::WalkFilter(Napi::Env env)
{
...
void ASTNode::WalkExtract(Napi::Env env)
{
...
void ASTNode::WalkReduce(Napi::Env env)
{
...
void ASTNode::WalkAll(Napi::Env env)
{
...
void ASTNode::WalkAny(Napi::Env env)
{
...
void ASTNode::WalkSingle(Napi::Env env)
{
...
void ASTNode::WalkNone(Napi::Env env)
{
...
void ASTNode::WalkShortestPath(Napi::Env env)
{
...
void ASTNode::WalkPatternPath(Napi::Env env)
{
  AddMember(env, "type", "pattern-path");
  LoopNodes(env, "elements", cypher_ast_pattern_path_nelements, cypher_ast_pattern_path_get_element);
}

void ASTNode::WalkNodePattern(Napi::Env env)
{
...
void ASTNode::WalkRelPattern(Napi::Env env)
{
...
void ASTNode::WalkRange(Napi::Env env)
{
...
void ASTNode::WalkCommand(Napi::Env env)
{
